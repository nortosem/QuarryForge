...
class TestFossilUtilCommands:
    ...
    def test_get_raw_timeline(self, mock_repo: MagicMock):
        ...
        expected_cmd = [
            ...
            fc.COMMAND.TYPE, fc.COMMAND.CI, fc.COMMAND.REPO,
            str(mock_repo),
        ]
    ...
    @pytest.mark.parametrize(
        ...
        [
            (MagicMock(
                __str__=lambda s: "/template.fossil"
            ), "QF", "Desc", [
                fc.COMMAND.TEMPLATE,
                "/template.fossil",
    ...
    def test_set_user_contact(self, mock_repo: MagicMock):
        ...
        expected_cmd = [
            fc.COMMAND.FOSSIL,
            fc.COMMAND.USER, fc.COMMAND.CONTACT, "user1",
            "user@example.com
            ", fc.COMMAND.REPO,
            str(mock_repo
                ),
    ...
    def test_get_parent_hash(self, mock_repo: MagicMock):
        ...
        version = "a1b2c3d4"
        expected_cmd = [
            fc.COMMAND.FOSSIL, fc.COMMAND.INFO, version,
    ...
    def test_get_file_changes(self, mock_repo: MagicMock):
        ...
        expected_cmd = [
            ...
            fc.COMMAND.FROM, from_v, fc.COMMAND.TO, to_v,
            fc.COMMAND.REPO, str(mock_repo),
        ]
    ...
    def test_get_file_content(self, mock_repo: MagicMock):
        ...
        expected_cmd = [
            fc.COMMAND.FOSSIL, fc.COMMAND.CAT, "src/main.c",
            fc.COMMAND.OUTFILE, "/tmp/main.c.out",
            fc.COMMAND.VERSION, "a1b2c3d4",
            fc.COMMAND.REPO, str(mock_repo),
        ]
        cmd = fossil_util.get_file_content("src/main.c", "/tmp/main.c.out", "a1b2c3d4", mock_repo)
        assert cmd == expected_cmd
    ...
    def test_add_files(self):
        ...
        expected_cmd = [
            fc.COMMAND.FOSSIL, fc.COMMAND.ADD, "file1.txt", "dir/file2.py",
        ]
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("feature-x", "v1.1", ['--branch', "feature-x", fc.COMMAND.TAG, "v1.1"]),
    ...
    def test_commit_mcdc(self, branch, tag, expected_extras):
        ...
        base_cmd = [
            ...
            fc.COMMAND.USER_OVERRIDE, "user1",
            fc.COMMAND.COMMENT, "Commit message",
        ]
        final_cmd = ["file1.txt"]
        expected_cmd = base_cmd + expected_extras + final_cmd
